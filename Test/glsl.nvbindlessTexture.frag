...
// Error cases, needs ARB_bindless_texture
void unsupportedCasts()
{
    sampler2D errSampler = sampler2D(uvTexturehandle); // Error: Needs ARB_bindless_texture
    uvec2 erruvTexHandle = uvec2(inSampler); // Error: Needs ARB_bindless_texture
}
